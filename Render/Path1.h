...
void send_texture(texbuffer_t *texbuf)
{
	...
	packet2_update(packet2, draw_texture_transfer(packet2->next, texture, 128, 128, GS_PSM_24, texbuf->address, texbuf->width));
...
void set_lod_clut_prim_tex_buff(texbuffer_t *t_texbuff)
{
	...
	t_texbuff->info.width = draw_log2(128); //texture size
